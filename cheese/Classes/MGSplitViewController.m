...
#define MG_DEFAULT_SPLIT_POSITION		200	// default width of master view in UISplitViewController.
#define MG_DEFAULT_SPLIT_WIDTH			3.0		// default width of split-gutter in UISplitViewController.
...
- (CGSize)splitViewSizeForOrientation:(UIInterfaceOrientation)theOrientation
{
	...
	if ([[Entity getInstance].orientations isEqualToString:@"Landscape"]) {
		width = height;
